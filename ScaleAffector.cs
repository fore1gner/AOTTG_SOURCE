...
public class ScaleAffector : Affector
{
	...
	public override void Update()
	{
		...
		{
			float num = base.Node.Scale.x + this.DeltaX * Time.deltaTime;
			float num2 = base.Node.Scale.y + this.DeltaY * Time.deltaTime;
			if (num * base.Node.Scale.x > 0f)
			{
				base.Node.Scale.x = num;
			}
			if (num2 * base.Node.Scale.y > 0f)
			{
				base.Node.Scale.y = num2;
			}
		}
	}
}
