...
public class AHSSShotGunCollider : MonoBehaviour
{
	...
	private void OnTriggerStay(Collider other)
	{
		...
		else if (other.gameObject.tag == "titanneck")
		{
			...
			if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
			{
				if (component2.transform.root.GetComponent<TITAN>() != null && !component2.transform.root.GetComponent<TITAN>().hasDie)
				{
					...
					int b2 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b2 = Mathf.Max(10, b2);
			...
			else if (!PhotonNetwork.isMasterClient)
			{
				if (component2.transform.root.GetComponent<TITAN>() != null)
				{
					if (!component2.transform.root.GetComponent<TITAN>().hasDie)
					{
						...
						int b3 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
						b3 = Mathf.Max(10, b3);
				...
				{
					int b4 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b4 = Mathf.Max(10, b4);
				...
				{
					int b5 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b5 = Mathf.Max(10, b5);
			...
			else if (component2.transform.root.GetComponent<TITAN>() != null)
			{
				...
				{
					int b6 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b6 = Mathf.Max(10, b6);
			...
			else if (component2.transform.root.GetComponent<FEMALE_TITAN>() != null)
			{
				if (!component2.transform.root.GetComponent<FEMALE_TITAN>().hasDie)
				{
					int b7 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b7 = Mathf.Max(10, b7);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
			...
			{
				int b8 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component2.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
				b8 = Mathf.Max(10, b8);
				if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
				{
		...
		else
		{
			...
			int b9 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - gameObject2.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
			b9 = Mathf.Max(10, b9);
