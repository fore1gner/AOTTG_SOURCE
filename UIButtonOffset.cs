...
public class UIButtonOffset : MonoBehaviour
{
	...
	private void OnPress(bool isPressed)
	{
		if (base.enabled)
		{
			...
			TweenPosition.Begin(this.tweenTarget.gameObject, this.duration, isPressed ? (this.mPos + this.pressed) : ((!UICamera.IsHighlighted(base.gameObject)) ? this.mPos : (this.mPos + this.hover))).method = UITweener.Method.EaseInOut;
		}
	}
