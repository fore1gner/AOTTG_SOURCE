...
public class UIButtonScale : MonoBehaviour
{
	...
	private void OnPress(bool isPressed)
	{
		if (base.enabled)
		{
			...
			TweenScale.Begin(this.tweenTarget.gameObject, this.duration, isPressed ? Vector3.Scale(this.mScale, this.pressed) : ((!UICamera.IsHighlighted(base.gameObject)) ? this.mScale : Vector3.Scale(this.mScale, this.hover))).method = UITweener.Method.EaseInOut;
		}
	}
