...
internal class MainApplicationManager : MonoBehaviour
{
	...
	{
		if (MainApplicationManager._firstLaunch)
		{
			MainApplicationManager._firstLaunch = false;
			MainApplicationManager._instance = SingletonFactory.CreateSingleton(MainApplicationManager._instance);
			MainApplicationManager.ApplicationStart();
		}
