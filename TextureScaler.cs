	...
	public static void BilinearScale(object obj)
	{
		...
		for (int i = 0; i < threadData.NewHeight; i++)
		{
			...
			for (int j = 0; j < newWidth; j++)
			{
				...
				threadData.NewColors[num6 + j] = TextureScaler.ColorLerpUnclamped(TextureScaler.ColorLerpUnclamped(texColors[num4 + num7], texColors[num4 + num7 + 1], value), TextureScaler.ColorLerpUnclamped(texColors[num5 + num7], texColors[num5 + num7 + 1], value), (float)i * num2 - (float)num3);
			}
		}
	}
