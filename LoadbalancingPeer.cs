...
internal class LoadbalancingPeer : PhotonPeer
{
	...
	public virtual bool OpAuthenticate(string appId, string appVersion, string userId, AuthenticationValues authValues, string regionCode)
	{
		...
		if (authValues != null && authValues.Secret != null)
		{
			...
			return this.OpCustom(230, dictionary, sendReliable: true, 0);
		}
		...
		bool num = this.OpCustom(230, dictionary, sendReliable: true, 0, base.IsEncryptionAvailable);
		if (!num)
		{
	...
	public virtual bool OpChangeGroups(byte[] groupsToRemove, byte[] groupsToAdd)
	{
		...
		return this.OpCustom(248, dictionary, sendReliable: true, 0);
	}
	...
	public virtual bool OpCreateRoom(string roomName, RoomOptions roomOptions, TypedLobby lobby, Hashtable playerProperties, bool onGameServer)
	{
		...
		return this.OpCustom(227, dictionary, sendReliable: true, 0);
	}
	...
	public virtual bool OpFindFriends(string[] friendsToFind)
	{
		...
		return this.OpCustom(222, dictionary, sendReliable: true, 0);
	}
	...
	public virtual bool OpGetRegions(string appId)
	{
		Dictionary<byte, object> dictionary = new Dictionary<byte, object>();
		dictionary[224] = appId;
		return this.OpCustom(220, dictionary, sendReliable: true, 0, encrypt: true);
	}
	...
	public virtual bool OpJoinLobby(TypedLobby lobby)
	{
		...
		return this.OpCustom(229, dictionary, sendReliable: true, 0);
	}
	...
	public virtual bool OpJoinRandomRoom(Hashtable expectedCustomRoomProperties, byte expectedMaxPlayers, Hashtable playerProperties, MatchmakingMode matchingType, TypedLobby typedLobby, string sqlLobbyFilter)
	{
		...
		return this.OpCustom(225, dictionary, sendReliable: true, 0);
	}
	...
	public virtual bool OpJoinRoom(string roomName, RoomOptions roomOptions, TypedLobby lobby, bool createIfNotExists, Hashtable playerProperties, bool onGameServer)
	{
		...
		return this.OpCustom(226, dictionary, sendReliable: true, 0);
	}
	...
	public virtual bool OpLeaveLobby()
	{
		...
		return this.OpCustom(228, null, sendReliable: true, 0);
	}
	...
	public virtual bool OpRaiseEvent(byte eventCode, object customEventContent, bool sendReliable, RaiseEventOptions raiseEventOptions)
	{
		...
		return this.OpCustom(253, dictionary, sendReliable, raiseEventOptions.SequenceChannel);
	}
	...
	protected void OpSetPropertyOfRoom(byte propCode, object value)
	{
		...
		this.OpSetPropertiesOfRoom(hashtable, broadcast: true, 0);
	}
}
