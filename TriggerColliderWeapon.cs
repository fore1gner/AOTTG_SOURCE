...
public class TriggerColliderWeapon : MonoBehaviour
{
	...
	private void OnTriggerStay(Collider other)
	{
		...
		if (other.gameObject.tag == "playerHitbox")
		{
			...
			if (!(component2 != null) || !(component2.transform.root != null) || component2.transform.root.GetComponent<HERO>().myTeam == this.myTeam || component2.transform.root.GetComponent<HERO>().isInvincible())
			{
				return;
			}
		...
		else if (other.gameObject.tag == "titanneck")
		{
			...
			if (!(component4 != null) || !this.checkIfBehind(component4.transform.root.gameObject) || this.currentHits.Contains(component4))
			{
				return;
			}
			component4.hitPosition = (base.transform.position + component4.transform.position) * 0.5f;
			this.currentHits.Add(component4);
			this.meatDie.Play();
			...
			if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
			{
				...
				{
					int b2 = (int)((component.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b2 = Mathf.Max(10, b2);
					...
					component5.die();
					this.napeMeat(this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity, component4.transform.root);
			...
			else if (!PhotonNetwork.isMasterClient)
			{
				if (component5 != null)
				{
					...
					{
						int b3 = (int)((component.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
						b3 = Mathf.Max(10, b3);
						if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
						{
				...
				else if (component4.transform.root.GetComponent<FEMALE_TITAN>() != null)
				{
					...
					int b4 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b4 = Mathf.Max(10, b4);
				...
				else if (component4.transform.root.GetComponent<COLOSSAL_TITAN>() != null)
				{
					...
					{
						int b5 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
						b5 = Mathf.Max(10, b5);
			...
			else if (component5 != null)
			{
				if (!component5.hasDie)
				{
					int b6 = (int)((component.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b6 = Mathf.Max(10, b6);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
			...
			else if (component4.transform.root.GetComponent<FEMALE_TITAN>() != null)
			{
				...
				if (!component4.transform.root.GetComponent<FEMALE_TITAN>().hasDie)
				{
					int b7 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b7 = Mathf.Max(10, b7);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
			...
			else if (component4.transform.root.GetComponent<COLOSSAL_TITAN>() != null)
			{
				...
				if (!component4.transform.root.GetComponent<COLOSSAL_TITAN>().hasDie)
				{
					int b8 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - component4.transform.root.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
					b8 = Mathf.Max(10, b8);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
		...
		{
			if (!(other.gameObject.tag == "titanankle") || this.currentHits.Contains(other.gameObject))
			{
				return;
			}
			this.currentHits.Add(other.gameObject);
			GameObject gameObject3 = other.gameObject.transform.root.gameObject;
			int b9 = (int)((this.currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.rigidbody.velocity - gameObject3.rigidbody.velocity).magnitude * 10f * this.scoreMulti);
			b9 = Mathf.Max(10, b9);
