...
internal class WeatherSet : BaseSetSetting
{
	...
	public FloatSetting FogDensity = new FloatSetting(0f, 0f, 1f);

	public ColorSetting FogColor = new ColorSetting(new Color(0.5f, 0.5f, 0.5f));

	public FloatSetting Rain = new FloatSetting(0f, 0f, 1f);

	public FloatSetting Thunder = new FloatSetting(0f, 0f, 1f);

	public FloatSetting Snow = new FloatSetting(0f, 0f, 1f);

	public FloatSetting Wind = new FloatSetting(0f, 0f, 1f);

	public BoolSetting UseSchedule = new BoolSetting(defaultValue: false);

	public BoolSetting ScheduleLoop = new BoolSetting(defaultValue: false);
