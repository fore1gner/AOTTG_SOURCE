...
public class TypewriterEffect : MonoBehaviour
{
	...
	private void Update()
	{
		if (this.mLabel == null)
		{
			...
			this.mText = this.mLabel.font.WrapText(this.mLabel.text, (float)this.mLabel.lineWidth / this.mLabel.cachedTransform.localScale.x, this.mLabel.maxLineCount, encoding: false, UIFont.SymbolStyle.None);
		}
