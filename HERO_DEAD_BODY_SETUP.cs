...
public class HERO_DEAD_BODY_SETUP : MonoBehaviour
{
	...
	public void init(string aniname, float time, BODY_PARTS part)
	{
		...
		case BODY_PARTS.UPPER:
			...
			Object.Destroy(this.leg);
			Object.Destroy(this.hand_l);
			Object.Destroy(this.hand_r);
			Object.Destroy(this.blood_lower);
			Object.Destroy(this.blood_arm_l);
			Object.Destroy(this.blood_arm_r);
		...
		case BODY_PARTS.ARM_L:
			...
			Object.Destroy(this.head);
			Object.Destroy(this.chest);
			Object.Destroy(this.leg);
			Object.Destroy(this.hand_r);
			Object.Destroy(this.blood_lower);
			Object.Destroy(this.blood_upper);
			Object.Destroy(this.blood_upper1);
			Object.Destroy(this.blood_upper2);
			Object.Destroy(this.blood_arm_r);
