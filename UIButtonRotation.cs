...
public class UIButtonRotation : MonoBehaviour
{
	...
	private void OnPress(bool isPressed)
	{
		if (base.enabled)
		{
			...
			TweenRotation.Begin(this.tweenTarget.gameObject, this.duration, isPressed ? (this.mRot * Quaternion.Euler(this.pressed)) : ((!UICamera.IsHighlighted(base.gameObject)) ? this.mRot : (this.mRot * Quaternion.Euler(this.hover)))).method = UITweener.Method.EaseInOut;
		}
	}
